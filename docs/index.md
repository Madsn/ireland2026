...
(function () {
  ...
  var planned = [
    ...
    { ll: [54.3260, -5.6990], popup: '<b>Downpatrick</b> · Leg 3 · contingency' },
    // Leg 4 — Belfast
    { ll: [54.6076, -5.9093], popup: '<b>Titanic Belfast</b> · Leg 4 · ⭐ pre-book' },
    { ll: [54.6084, -5.9098], popup: '<b>SS Nomadic</b> · Leg 4' },
    { ll: [54.5841, -5.9338], popup: '<b>Ulster Museum</b> · Leg 4 · free' },
    { ll: [54.6400, -5.7840], popup: '<b>Ulster Folk Museum (Cultra)</b> · Leg 4' },
  ...
  var planb = [
    ...
    { ll: [54.3930, -5.6500], popup: '<b>Delamont Country Park</b> · Leg 3 · Plan B · Strangford Lough' },
    // Leg 4
